...
int esFechaValida(int pResultadoMes, int pResultadoDia, int pResultadoAnio, int anioMin, int aniMax)
{
	int retorno = 1;
	switch(pResultadoMes)
	{
		case 4:
		case 6:
		case 9:
...
int getFecha(int* pResultadoMes, int* pResultadoDia, int* pResultadoAnio, char* mensajeError, int anioMin, int anioMax)
{
	int retorno = 0;


	utn_getEntero(pResultadoDia, "Ingrese el dia: ", "(!)Dia invalido. ", 1, 31);
	utn_getEntero(pResultadoMes, "Ingrese el mes: ", "(!)Mes invalido. ", 1, 12);
	utn_getEntero(pResultadoAnio, "Ingrese el año: ", "(!)Año invalido. ", anioMin, anioMax);
	retorno  = 1;
	return retorno;
...
int utn_getFecha(int* pResultadoMes, int* pResultadoDia, int* pResultadoAnio, char* mensajeError, int anioMin, int anioMax)
{
	int retorno = -1;
	int bandera = 0;
	int dia;
	...
	do
	{
		if(getFecha(&mes, &dia, &anio, mensajeError, anioMin, anioMax) == 1 &&
			esFechaValida(mes, dia, anio, anioMin, anioMax) == 1)
		{
			*pResultadoMes = mes;
			*pResultadoDia = dia;
			*pResultadoAnio = anio;
...
int utn_getFechaString(char* fecha, int longitud, int anioMin, int anioMax)
{
	int retorno = -1;
	int anio;
	int mes;
	...
	if(utn_getFecha(&mes, &dia, &anio, "(!)Fecha invalida. ", anioMin, anioMax) == 0)
	{
	...
	strcat(diaStr, "/");
	strcat(diaStr, mesStr);
	strcat(diaStr, "/");
	fecha = strcat(diaStr, anioStr);
