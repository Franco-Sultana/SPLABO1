...
/**
 * @fn int descuentoPlaneta(void*)
 * @brief calcula el descuento correspondiente al libro
 * @param pElement puntero a void, que luego va a apuntar a direccion de memoria de un lbiro
 * @return 0 si al libro no le corresponde descuento || 1 si si
 */
int descuentoPlaneta(void* pElement);

/**
 * @fn int eLibro_retornarLibroMas500(void*, int)
 * @brief retorna si un libro cuesta mas de 500 pe
 * @param pElement puntero a void, que luego va a apuntar a direccion de memoria de un lbiro
 * @param entero entero que se usa para definir por que se compara
 * @return 1 si un libro cuesta mas de 500 || 0 si no
 */
int eLibro_retornarLibroMas500(void* pElement, int entero);

/**
 * @fn int eLibro_retornarPrecioPearson(void*, int)
 * @brief retorna el precio del libro de una editorial
 * @param pElement puntero a void, que luego va a apuntar a direccion de memoria de un lbiro
 * @param entero entero que se usa para definir por que se compara
 * @return 1 si un libro es de cierta editorial || 0 si no
 */
