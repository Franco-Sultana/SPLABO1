...
/**
 * @fn int esCuit(char*, int)
 * @brief Valida que el cuit ingresado sea correcto
...
/**
 * @fn int getCuit(char*, int)
 * @brief  copia el cuit que ingresa el usuario en el puntero resultado
 ...
 * @brief Pide un cuit al usuario y luego de ser vaidado lo guarda
...
/**
 * @fn int utn_getFechaString(char*, int, int, int)
 * @brief Pide una fecha en modo string
 * @param fecha puntero que va a apuntar a la direccion de memoria donde apunta la fecha
 * @param longitud tamaño de la cadena de caracteres de fecha
 * @param anioMin año minimo permitido
 * @param anioMax año maximo permitido
 * @return -1 si la fecha es erronea || 1 si la fecha es correcta
 */
